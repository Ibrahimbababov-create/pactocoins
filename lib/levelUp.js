...
// и если да — выдаёт награду (если объявлена) и поздравляет в группе.
// Вызывать ПОСЛЕ того, как users.total_earned уже обновлён в базе —
// функция сама перечитывает свежие данные.
