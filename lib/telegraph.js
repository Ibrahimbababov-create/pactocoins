...
// Из telegra.ph может прийти ссылка вида javascript:… — в обычном тексте
// она безобидна, а в нашей вёрстке станет кликабельным кодом. Пускаем
// только нормальные схемы.
...
function renderNode(node) {
  ...
  if (tag === "a") {
    ...
    href = safeUrl(href);
    // Ссылка с непонятной схемой — оставляем текст, убираем кликабельность.
    if (!href) return kids;
