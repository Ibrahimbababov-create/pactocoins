...
const LIGHT_SEGMENTS = new Set(["#A3FF12", "#BCFF52", "#7FCF12"]);

// Текст на светлом сегменте — тёмный, на графите — светлый.
export function segmentTextColor(color) {
  return LIGHT_SEGMENTS.has(String(color).toUpperCase()) ? "#07080A" : "#F2F5EF";
}
